<nav class="sidebar dark_sidebar mini_sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="{{ route('index') }}"><img src="{{ asset('assets/img/logo.png') }}" alt=""></a>
        <a class="small_logo" href="{{ route('index') }}"><img src="{{ asset('assets/img/mini_logo.png') }}" alt=""></a>
