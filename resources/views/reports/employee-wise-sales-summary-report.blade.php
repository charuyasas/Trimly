...
@include('includes.sidebar', ['pageTitle' => 'Employee wise Sales Summary Report'])
...
<script>
    ...
    function loadSalesSummary() {
        ...
        $.get(apiUrl, { start_date: startDate, end_date: endDate, item_type: itemType, report_type: 'employee_wise' }, function(data) {
    ...
    function printSalesSummary() {
        ...
        <html>
            <head>
                ...
                <style>
                    @page {
                        size: A4 portrait;    /* Always portrait, fit page */
                        margin: 10mm;
                    }
                    body {
                    ...
                    table {
                        ...
                        max-width: 100%;       /* don’t exceed paper */
                    ...
                    th:nth-child(2), td:nth-child(2) { width: 35%; }  /* Salesman */
                    th:nth-child(3), td:nth-child(3) { width: 15%; }  /* Total Sales */
                    th:nth-child(4), td:nth-child(4) { width: 15%; }  /* Total Discount */
                    th:nth-child(5), td:nth-child(5) { width: 15%; }  /* Commission */
                    th:nth-child(6), td:nth-child(6) { width: 15%; }  /* Profit */
                </style>
            </head>
            <body>
