            ...
            <div class="col-lg-12 p-0 ">
                <div class="header_iner d-flex justify-content-between align-items-center">
                    ...
                    <div class="line_icon open_miniSide d-none d-lg-block">
                        <img src="<?php echo e(asset('assets/img/line_img.png')); ?>" alt="">
                    </div>
                    <div class="serach_field-area d-flex align-items-center">
                        <div class="search_inner">
                            <form action="#">
                                ...
                                <button type="submit"> <img src="<?php echo e(asset('assets/img/icon/icon_search.svg')); ?>" alt=""> </button>
                            </form>
                        </div>
                    </div>
                    <div class="header_right d-flex justify-content-between align-items-center">
                        <div class="header_notification_warp d-flex align-items-center">
                            <li>
                                <a class="bell_notification_clicker" href="#"> <img src="<?php echo e(asset('assets/img/icon/bell.svg')); ?>" alt="">
                                    <span>2</span>
                                </a>
                                ...
                                <div class="Notification_body">
                                    ...
                                    <div class="single_notify d-flex align-items-center">
                                        <div class="notify_thumb">
                                            <a href="#"><img src="<?php echo e(asset('assets/img/staf/2.png')); ?>" alt=""></a>
                                        </div>
                                    ...
                                    <div class="single_notify d-flex align-items-center">
                                        <div class="notify_thumb">
                                            <a href="#"><img src="<?php echo e(asset('assets/img/staf/4.png')); ?>" alt=""></a>
                                        </div>
                                        <div class="notify_content">
                                    ...
                                    <div class="single_notify d-flex align-items-center">
                                        <div class="notify_thumb">
                                            <a href="#"><img src="<?php echo e(asset('assets/img/staf/3.png')); ?>" alt=""></a>
                                        </div>
                                        <div class="notify_content">
                            ...
                            <li>
                                <a class="CHATBOX_open" href="#"> <img src="<?php echo e(asset('assets/img/icon/msg.svg')); ?>" alt=""> <span>2</span>  </a>
                            </li>
                        </div>
                    ...
                    <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="page_title_right">
                            <div class="page_date_button d-flex align-items-center"> 
                                <img src="<?php echo e(asset('assets/img/icon/calender_icon.svg')); ?>" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    <div class="crm_head d-flex align-items-center justify-content-between" >
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/crm/businessman.svg')); ?>" alt="">
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm ">
                                    <div class="crm_head crm_bg_1 d-flex align-items-center justify-content-between" >
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/crm/customer.svg')); ?>" alt="">
                                        </div>
                                        <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                    </div>
                                    <div class="crm_body">
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    <div class="crm_head crm_bg_2 d-flex align-items-center justify-content-between" >
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/crm/infographic.svg')); ?>" alt="">
                                        </div>
                                        <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                    </div>
                                    <div class="crm_body">
                            ...
                            <div class="col-lg-6">
                                <div class="single_crm">
                                    <div class="crm_head crm_bg_3 d-flex align-items-center justify-content-between" >
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/crm/sqr.svg')); ?>" alt="">
                                        </div>
                                        <i class="fas fa-ellipsis-h f_s_11 white_text"></i>
                                    </div>
                                    <div class="crm_body">
                        ...
                        <div class="white_card_body ">
                            <div class="single_user_pil d-flex align-items-center justify-content-between">
                                <div class="user_pils_thumb d-flex align-items-center">
                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/1.png')); ?>" alt=""></div>
                            ...
                            <div class="monthly_plan_wraper">
                                <div class="single_plan d-flex align-items-center justify-content-between">
                                    <div class="plan_left d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/icon2/7.svg')); ?>" alt="">
                                        </div>
                                        <div>
                                            <h5>Most Sales</h5>
                                ...
                                <div class="single_plan d-flex align-items-center justify-content-between">
                                    <div class="plan_left d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/icon2/6.svg')); ?>" alt="">
                                        </div>
                                        <div>
                                ...
                                <div class="single_plan d-flex align-items-center justify-content-between">
                                    <div class="plan_left d-flex align-items-center">
                                        <div class="thumb">
                                            <img src="<?php echo e(asset('assets/img/icon2/5.svg')); ?>" alt="">
                                        </div>
                                        <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="single_plan d-flex align-items-center justify-content-between">
                                            <div class="plan_left d-flex align-items-center">
                                                <div class="thumb">
                                                    <img src="<?php echo e(asset('assets/img/icon2/3.svg')); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h5>$2,034</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="single_plan d-flex align-items-center justify-content-between">
                                            <div class="plan_left d-flex align-items-center">
                                                <div class="thumb">
                                                    <img src="<?php echo e(asset('assets/img/icon2/1.svg')); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h5>$706</h5>
                                                    <span>Commision</span>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="single_plan d-flex align-items-center justify-content-between">
                                            <div class="plan_left d-flex align-items-center">
                                                <div class="thumb">
                                                    <img src="<?php echo e(asset('assets/img/icon2/4.svg')); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h5>$49</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="single_plan d-flex align-items-center justify-content-between">
                                            <div class="plan_left d-flex align-items-center">
                                                <div class="thumb">
                                                    <img src="<?php echo e(asset('assets/img/icon2/2.svg')); ?>" alt="">
                                                </div>
                                                <div>
                                                    <h5>$5.8M</h5>
                                ...
                                <table class="table lms_table_active2 p-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/pro_1.png')); ?>" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/pro_2.png')); ?>" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/pro_3.png')); ?>" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/pro_4.png')); ?>" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/pro_5.png')); ?>" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="<?php echo e(asset('assets/img/customers/pro_6.png')); ?>" alt=""></div>
                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="thumb mb_30">
                                <img src="<?php echo e(asset('assets/img/table.svg')); ?>" alt="" class="img-fluid">
                            </div>
                ...
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="<?php echo e(asset('assets/img/staf/1.png')); ?>" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="<?php echo e(asset('assets/img/staf/2.png')); ?>" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="<?php echo e(asset('assets/img/staf/3.png')); ?>" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="<?php echo e(asset('assets/img/staf/4.png')); ?>" alt="">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                         <img src="<?php echo e(asset('assets/img/staf/5.png')); ?>" alt="">
                        </div>
                    </a>
                </li>
                <li>
