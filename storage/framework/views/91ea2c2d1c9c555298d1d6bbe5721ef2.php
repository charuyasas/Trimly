<nav class="sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="index-2.html"><img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt=""></a>
        <a class="small_logo" href="index-2.html"><img src="<?php echo e(asset('assets/img/mini_logo.png')); ?>" alt=""></a>
    ...
    <ul id="sidebar_menu">
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/dashboard.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/2.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/3.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Pages</span>
            </div>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/4.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Admins</span>
            </div>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/11.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
        ...
        <li class="">
            <a  href="navs.html" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/12.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Navs</span>
            </div>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/5.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Users</span>
            </div>
        ...
        <li>
            <a href="Builder.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/6.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
                    <span>Builder </span>
                </div>
        ...
        <li class="">
            <a  href="invoice.html" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/7.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Invoice</span>
            </div>
        ...
        <li class="">
            <a  class="has-arrow" href="#" aria-expanded="false">
              <div class="nav_icon_small">
                  <img src="<?php echo e(asset('assets/img/menu-icon/8.svg')); ?>" alt="">
              </div>
              <div class="nav_title">
                  <span>forms</span>
              </div>
          ...
          <li class="">
              <a href="Board.html" aria-expanded="false">
                  <div class="nav_icon_small">
                      <img src="<?php echo e(asset('assets/img/menu-icon/9.svg')); ?>" alt="">
                  </div>
                  <div class="nav_title">
                      <span>Board</span>
                  </div>
        ...
        <li class="">
            <a  href="calender.html" aria-expanded="false">
              <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/10.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Calander</span>
            </div>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
            <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/13.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Products</span>
            </div>
        ...
        <li class="">
          <a   class="has-arrow" href="#" aria-expanded="false">
            <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/14.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Icons</span>
            </div>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/15.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
          ...
          <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/16.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
          ...
          <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/17.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
                    <span>Table</span>
                </div>
          ...
          <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="<?php echo e(asset('assets/img/menu-icon/18.svg')); ?>" alt="">
                </div>
                <div class="nav_title">
                    <span>Cards</span>
                </div>
        ...
        <li class="">
          <a   class="has-arrow" href="#" aria-expanded="false">
            <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/19.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Charts</span>
            </div>
        ...
        <li class="">
            <a   class="has-arrow" href="#" aria-expanded="false">
              <div class="nav_icon_small">
                  <img src="<?php echo e(asset('assets/img/menu-icon/20.svg')); ?>" alt="">
              </div>
              <div class="nav_title">
                  <span>UI Kits </span>
              </div>
        ...
        <li class="">
          <a   class="has-arrow" href="#" aria-expanded="false">
            <div class="nav_icon_small">
                <img src="<?php echo e(asset('assets/img/menu-icon/21.svg')); ?>" alt="">
            </div>
            <div class="nav_title">
                <span>Widgets</span>
            </div>
